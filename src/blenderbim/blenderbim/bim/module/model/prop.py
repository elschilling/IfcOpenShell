...
class BIMRoofProperties(PropertyGroup):
    ...
    percentage: bpy.props.FloatProperty(name="Slope %", default=17.63269754733197, step=0.00000000000001, subtype="PERCENTAGE", update=lambda self, context: self.update_angle())
